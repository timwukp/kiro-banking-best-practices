...
- **Enforced config-level security:** `kiro-docs/agent-runtime-governance.md` (CLI agent: tool permissions, hooks, OS file lockdown); enterprise/registry layer: `kiro-docs/security-governance-features.md`.
